...
import { ContainerColor, Section, ButtonContainer } from '../ComponentStyles/ComponentStyles'
...
const Courses = () => {
    ...
    return (
        <ContainerColor id='courses'>
            ...
            <ButtonContainer>
                <Button link='https://classroom.google.com/c/NjIwOTY5MzAwMDRa?cjc=zbcpgcl' text='muestra' />
